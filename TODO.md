...
- [ ] Allow user to pick and see what packages are added and for what purpose they will be installed
...
- [ ] Add automatic **SSD/HDD** detection so as to not mess with certain settings if they do not work
...
- [ ] See if there is some way to add commands to arch-chroot like through popen
